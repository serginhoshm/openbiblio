...
<table class="primary">
  ...
  <tr>
    <td nowrap="true" class="primary">
      ...
      <td class="borderless"><span id="duedate1" style="display:none"><?php echo $loc->getText("Data de vencimento:"); ?></td>
      <td class="borderless">
        <small id="duedateoverride"><a href="javascript:showDueDate()"><?php echo $loc->getText("Alterar data de vencimento"); ?></a></small>
      ...
      <td>
        <span id="duedate3" style="display:none"><input type="button" value="<?php echo $loc->getText("Cancelar"); ?>" class="button" onclick="hideDueDate()" /></span>
      </td>
      </tr>
      </table>
    </td>
...
<h1><?php echo $loc->getText("mbrViewHead4"); ?>
  ...
  <a href="../circ/mbr_renew_all.php?mbrid=<?php echo HURL($mbrid); ?>">[Renovar Tudo]</a>
  </font>
</h1>
<table class="primary">
  <tr>
...
?>
  <tr>
    <td class="primary" valign="top" nowrap="yes">
      <?php echo H(date('d/m/Y', strtotime($biblio->getStatusBeginDt())));?>
    </td>
    <td class="primary" valign="top">
    ...
    <td class="primary" valign="top" nowrap="yes">
      <?php echo H(date('d/m/Y', strtotime($biblio->getDueBackDt())));?>
    </td>
    <td class="primary" valign="top" >
      <a href="../circ/checkout.php?barcodeNmbr=<?php echo HURL($biblio->getBarcodeNmbr());?>&amp;mbrid=<?php echo HURL($mbrid);?>&amp;renewal">Renovar item</A>
      <?php
